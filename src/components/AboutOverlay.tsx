...
const VERSION_HISTORY: { v: string; detail: string }[] = [
  ...
  { v: 'V2.2', detail: 'Siri voice control (iOS). Say "Hey Siri, tune VibeSDR" — Siri asks what — then a frequency (7.150 MHz / 7150 kHz / 7151.5), a station ("Radio Caroline"), or a band ("40m ham"), and it tunes with the right demodulator + step. Also "change VibeSDR mode" → AM / SAM / synchronous AM / LSB / lower side band / …, and "set VibeSDR step rate" → 100 Hz, 9 kHz, … With a default instance set it can run from closed; otherwise it asks you to set one. (Note: Apple only lets a value sit inside a one-shot Siri phrase for fixed lists, so tuning is a two-step ask-and-answer. Android’s in-car answer stays the Android Auto Bookmarks/Band-Plan browse — Google Assistant needs Play Store publishing.)' },
];
