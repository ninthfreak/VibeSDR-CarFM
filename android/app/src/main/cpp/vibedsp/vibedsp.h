...
public:
    ...
    // Hardware-RDS backends that deliver already-synced block groups (a chip or
    // head-unit tuner that hands over A..D + per-block validity, rather than a raw
    // bitstream): feed them straight into the SAME parser — PS/RT/RT+/PTY/TA/AF
